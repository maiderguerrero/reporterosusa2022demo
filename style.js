(function (blink) {
	...
	var reporterosusa2022demoStyle = function () {
			blink.theme.styles.basic.apply(this, arguments);
		},
		page = blink.currentPage;

	reporterosusa2022demoStyle.prototype = {
		//BK-15873 añadimos el estilo basic como parent para la herencia de los estilos del CKEditor
		parent: blink.theme.styles.basic.prototype,
		bodyClassName: 'content_type_clase_reporterosusa2022demo',
		ckEditorStyles: {
			name: 'reporterosusa2022demo',
			styles: [
		...
		formatCarouselindicators: function (scope, classNavbar) {
			var that = scope || this,
				navbar = ((typeof classNavbar !== "undefined" && classNavbar)?classNavbar:'reporterosusa2022demo-navbar'),
	...
	reporterosusa2022demoStyle.prototype = _.extend({}, new blink.theme.styles.basic(), reporterosusa2022demoStyle.prototype);

	blink.theme.styles['reporterosusa2022demo'] = reporterosusa2022demoStyle;
